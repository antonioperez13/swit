/*
o * This file is part of the OWL API.
 *
...
public class SimpleHierarchyExample {
    ...
    private String labelFor(OWLClass clazz) {
        ...
        Collection<OWLAnnotation> annotations = EntitySearcher.getAnnotations(clazz.getIRI(), ontology);
    ...
    public static void main(String[] args) throws OWLException, InstantiationException,
        ...
        args[0] = "file:///d://Universidad//Universidad_2016-2017//TFG//SWIT//molecule.owl";
